...
export const CalendarIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0h18M12 12.75h.008v.008H12v-.008zm0 3h.008v.008H12v-.008zm-3-3h.008v.008H9v-.008zm0 3h.008v.008H9v-.008zm-3-3h.008v.008H6v-.008zm0 3h.008v.008H6v-.008zm6-3h.008v.008H12v-.008zm3 0h.008v.008H15v-.008zm-6 3h.008v.008H9v-.008zm3 0h.008v.008H12v-.008z" />
    </svg>
);
...
export const Cog8ToothIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-1.226l.542-.218a2.25 2.25 0 012.165 0l.542.218c.55.219 1.02.684 1.11 1.226l.09.542-.09.542c-.09.542-.56 1.007-1.11 1.226l-.542.218a2.25 2.25 0 01-2.165 0l-.542-.218c-.55-.219-1.02-.684-1.11-1.226L9.594 3.94zM4.875 9.188l.542.09a1.94 1.94 0 011.226 1.11l.218.542a2.25 2.25 0 000 2.165l-.218.542a1.94 1.94 0 01-1.226 1.11l-.542.09-.542-.09a1.94 1.94 0 01-1.226-1.11l-.218-.542a2.25 2.25 0 000-2.165l.218-.542a1.94 1.94 0 011.226-1.11l.542-.09zM15 12a3 3 0 11-6 0 3 3 0 016 0z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M19.125 9.188l.542.09a1.94 1.94 0 011.226 1.11l.218.542a2.25 2.25 0 000 2.165l-.218.542a1.94 1.94 0 01-1.226 1.11l-.542.09-.542-.09a1.94 1.94 0 01-1.226-1.11l-.218-.542a2.25 2.25 0 000-2.165l.218-.542a1.94 1.94 0 011.226-1.11l.542-.09zM9.594 20.06c.09.542.56 1.007 1.11 1.226l.542.218a2.25 2.25 0 012.165 0l.542.218c.55.219 1.02.684 1.11 1.226l.09.542-.09.542c-.09.542-.56 1.007-1.11 1.226l-.542.218a2.25 2.25 0 01-2.165 0l-.542-.218c-.55-.219-1.02-.684-1.11-1.226L9.594 20.06z" />
    </svg>
);
...
export const PaintBrushIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4-2.4 3 3 0 001.128-5.78m1.128 5.78l3.87-3.87a3 3 0 00-4.242-4.242l-3.87 3.87m0 0a2.25 2.25 0 012.4 2.4m4.242 0l-4.242 4.242M9.53 16.122L13.4 12.25m3.87-3.87a3 3 0 00-4.242-4.242l-3.87 3.87m4.242 4.242l4.242 4.242a3 3 0 004.242-4.242l-3.87-3.87m-4.242 4.242a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4-2.4 3 3 0 001.128-5.78" />
    </svg>
);
